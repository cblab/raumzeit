...
The divergence between global K2 shifts and fixed-anchor K7 behavior is itself informative: local patch retuning does not translate into robust macroscopic isotropic closure.
